...
3. Claude must use conventional commit format only:
   feat:, spec:, docs:, chore:, fix:
4. Each commit must reference:
   - Module
   - Chapter
   - Task number
5. Claude must push changes to GitHub after each commit.
...
10. Claude must log commit hash into validation.md and must NOT commit any changes after logging the commit hash to validation.md.
