---
title: Chapter 2 - ROS 2 Nodes, Topics, Services, and Robot Communication
---
...
- [Lesson 1: Nodes with Multiple Communication Patterns](./nodes-multiple-communication-patterns.md)
- [Lesson 2: Service-based Communication](./service-based-communication.md)
- [Lesson 3: Parameter Server Configuration](./parameter-server-configuration.md)